...
class gui_class:
                ...
                if v1 == 0 or v2 == 0:
                    ...
                    if var3 == 0 and var4 == 1:
                        canvas.create_rectangle(current.d1, current.d2,
                                                current.d3 - ((current.width * scale) - (v2 * scale)), current.d4,
                                                fill='snow3')
    ...
    class Buttons:
        def __init__(self, root, master):
            ...
            b1 = tk.Button(master.frame1, width=15, text='Irregular Floor Plan', relief='flat', **button_details,
                           command=master.single_floorplan)
            b1.grid(row=1, column=0, padx=5, pady=5)

            b2 = tk.Button(master.frame1, width=15, text='Multiple Irregular Floor Plans', relief='flat',
            ...
            c1 = tk.Checkbutton(master.frame1, text="Dimensioned", relief='flat', **button_details,
                                selectcolor='#4A4E69', width=13, variable=master.checkvar1, onvalue=1, offvalue=0)
            c1.grid(row=5, column=0, padx=5, pady=5)

            b3 = tk.Button(master.frame1, width=15, text='Rectangular Floor Plan', relief='flat', **button_details,
                           command=master.single_oc_floorplan)
            b3.grid(row=3, column=0, padx=5, pady=5)

            b4 = tk.Button(master.frame1, width=15, text='Multiple Rectangular Floor Plans', relief='flat',
                           **button_details, command=master.multiple_oc_floorplan)
            b4.grid(row=4, column=0, padx=5, pady=5)

            b6 = tk.Button(master.frame1, width=15, text='Circulation', relief='flat', **button_details,
    ...
    def completeStructure(self):
        self.canvasForOuterBoundary.create_line(self.outer_boundary2[len(self.outer_boundary2) - 1][2],
                                                self.outer_boundary2[len(self.outer_boundary2) - 1][3],
